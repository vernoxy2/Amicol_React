...
import { EpoxyFloorCoatingsData } from "../../../../Data/EpoxyFloorCoatingsData";
import { ProductCards } from "../../../../Components/UI/ProductCards";

const EpoxyFloorCoatings = () => {
  ...
  return (
    <section id="2k-epoxy-floor-coatings" className="bg-[#F4F4F4] py-14">
      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 pt-6">
        {EpoxyFloorCoatingsData.map((item) => (
...
export default EpoxyFloorCoatings;
